<table id="dgbiji" title="Menu" class="easyui-datagrid" style="width:100%;height:250px" url=""
...
<div id="dlgbiji" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px" closed="true" buttons="#dlgbiji-buttons">

		<form id="fmbiji" method="post" novalidate>
		  <table cellpadding="5">
		<tr>
		<td>Jenis Menu</td>
