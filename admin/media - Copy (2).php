									...
									<li data-options="state:'closed',iconCls:'icon-setting'">
										...
										<ul>
											...
											<li data-options="iconCls:'icon-human'">
												<a href="javascript:void(0)" onclick="addTab('Rumah Makan','content.php?act=profil_rm');" class="easyui" style="text-decoration: none;color: #000;" ><span>Rumah Makans</span></a>
											</li>
